        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6283866366437@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
var butonnya =
[{ urlButton: { displayText: 'Group Official', url:'https://chat.whatsapp.com/KNuPWvGn3AG0srT3vdr0Ea'}},
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/kannachan'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number',
                                    phoneNumber: '+62 838-6636-6437'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Speed',
...
break
case 'ssweb': {
if (!args[0]) return reply(`Example : \n${prefix + command} https://instagram.com/kannachan`)
